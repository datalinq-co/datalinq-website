          ...
          <Navbar.Container>
            <Navbar.ItemsLeft>
              <Navbar.IconsContainer>
                <Navbar.Logo link="#Homepage" image={navbar.logo}>
                  Instream Media
                </Navbar.Logo>
                <MobileMenu>
        ...
        <MobileMenu.OptionMenuContainer>
          <MobileMenu.OptionMenu>
            <MobileMenu.OptionHeader>
              <MobileMenu.OptionLogo
                src="/img/logo-dark.png"
                alt="Instream-Media"
              />
              <MobileMenu.OptionCloseIcon
            ...
            <MobileMenu.OptionContainer>
              {navbar.navopts.map(ele => {
                return (
                  <Navbar.TextLinks
                    link={ele.link}
                    classExtra="block px-3 py-2 rounded-md text-base text-gray-700 hover:bg-gray-50"
                  >
                    {ele.title}
                  </Navbar.TextLinks>
                )
